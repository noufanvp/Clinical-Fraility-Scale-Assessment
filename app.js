...
function convertToCSV(assessments) {
  ...
  const rows = assessments.map((assessment) => {
    ...
    return [
      ...
      // BADLS
      resp.dress === "1" ? "Yes" : resp.dress === "0" ? "No" : "",
      resp.eat === "1" ? "Yes" : resp.eat === "0" ? "No" : "",
      resp.walk === "1" ? "Yes" : resp.walk === "0" ? "No" : "",
      resp.bed === "1" ? "Yes" : resp.bed === "0" ? "No" : "",
      resp.bath === "1" ? "Yes" : resp.bath === "0" ? "No" : "",
      // IADLS
      resp.telephone === "1" ? "Yes" : resp.telephone === "0" ? "No" : "",
      resp.shopping === "1" ? "Yes" : resp.shopping === "0" ? "No" : "",
      resp.cooking === "1" ? "Yes" : resp.cooking === "0" ? "No" : "",
      resp.housework === "1" ? "Yes" : resp.housework === "0" ? "No" : "",
      resp.medicine === "1" ? "Yes" : resp.medicine === "0" ? "No" : "",
      resp.money === "1" ? "Yes" : resp.money === "0" ? "No" : "",
      // Chronic conditions
